    ...
    const handleSignIn = async () => {
        try {
            ...
            if (!response.ok) {
                ...
                setError(errorData.error || 'Email or password does not match. Please try again.');
                return;
            }

            const userData = await response.json();
            // Add password_hash for compatibility with User type
            const completeUser: User = { ...userData, password_hash: '' } as User;
            signIn(completeUser);
